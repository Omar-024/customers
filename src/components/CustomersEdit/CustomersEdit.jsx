...
export default function CustomersEdit() {
    ...
    const handelShow=(id)=>{
        axios.get(`https://dev.thetechtitans.net/api/customers/${id}` , {
             headers:{
                authorization:token ,
                company:1 ,
        ...
        const handleShowTable=()=>{
           ...
           formik.handleChange
            ...
            let formik =useFormik({
                ...
                onSubmit:(values)=>{
                    console.log(values)
                    axios.put(`https://dev.thetechtitans.net/api/customers/${id}` , values ,{
                         headers:{
                            authorization:token ,
                            company:1 ,
                            Accept:"application/json"
  ...
  <form onSubmit={formik.handleSubmit} >
   ...
   <button type="submit" className=" cursor-pointer  mb-5 w-full text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2  dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">  تحديث </button>
