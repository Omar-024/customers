...
export default function Customers() {
   ...
   let{token} =useContext(myauthcontext)
      ...
      useEffect(()=>{
        ...
        // const dataShow= customers?.filter((cusromer)=>cusromer.name.toLowerCase().includes(search.toLowerCase()))
  ...
  return <>
  {/* {dataShow?.length>0?<main className='bg-[#EEEEEE] min-h-screen'>
         <div className="container">
            ...
            <div dir='rtl' className='w-full mb-5'>
                <InputSearch  dataShow={dataShow} customers={customers}  setcustomers={setcustomers} searchValue={search} setSearch={setSearch} deleteCustomer={deleteCustomer} />
            </div>
            ...
            <div className="relative overflow-x-auto shadow-md sm:rounded-lg">
                <table className="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                    ...
                    <tbody>
                            ...
                            <tr key={index} className="odd:bg-white *:text-center odd:dark:bg-gray-900 even:bg-gray-50 even:dark:bg-gray-800 border-b dark:border-gray-700 border-gray-200">
